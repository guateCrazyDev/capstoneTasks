...
public class PlaceController {
	...
	public ResponseEntity<PlaceRecord> createPlace(@RequestPart("placeData") PlaceRecord placeRecord,@RequestPart("files") List<MultipartFile> files,@RequestPart("categoryName") String categoryName){
